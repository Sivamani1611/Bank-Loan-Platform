function validatePassword(passwordId = "") {
    ...
    const passwordText = document.getElementById(passwordId).value;
...
function matchPassword(currPasswordId, enteredPasswordId) {

    const enteredPassword = document.getElementById(enteredPasswordId).value;

    const currPassword = document.getElementById(currPasswordId).value;

    const confirmPasswordTag = document.getElementById("confirmPasswordTag");

    if(currPassword !== enteredPassword) {
