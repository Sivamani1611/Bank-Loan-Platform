                            ...
                            <form id="registerForm" onsubmit="(handleRegisterFormSubmit(event))">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" id="registerPasswordField" required minlength="6" onkeyup="(validatePassword(event.target.value, 'registerPasswordField'))">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                        <input type="password" class="form-control" id="registerConfirmPasswordField" required minlength="6" onkeyup="(matchPassword(event.target.value))">
