                            ...
                            <form id="resetPasswordForm" onsubmit="(handleResetFormSubmit(event))">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" id="resetPasswordField" required minlength="6" onkeyup="(validatePassword(('resetPasswordField')))">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                        <input type="password" class="form-control" id="resetConfirmPasswordField" required minlength="6" onkeyup="(matchPassword(('resetConfirmPasswordField'), ('resetPasswordField')))">
